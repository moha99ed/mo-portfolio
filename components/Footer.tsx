...
<footer class="fixed bottom-0 left-0 z-20 w-full p-4 bg-white dark:bg-gray-900">
    ...
    <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        ...
        <a href="https://github.com/moha99ed" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="http://www.linkedin.com/in/m-sebbagh" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="http://www.facebook.com" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
